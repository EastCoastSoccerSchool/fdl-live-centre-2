...
const styles = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .fdl-logo-badge .soccer-icon {
    font-size: 20px;
  }
  .fdl-logo-badge .fdl-text {
    font-size: 13px;
    font-weight: 900;
    color: #0a1628;
    letter-spacing: 1px;
  ...
  @media (max-width: 768px) {
    ...
    .fdl-title-pre, .fdl-title-season { font-size: 30px; }
...
export default function TournamentPanel({ mode = "public" }) {
  ...
  return (
    <div className="page" style={{ overflowX: "hidden" }}>
      ...
      {/* ══════════════════════════════════════
          BRANDED HEADER — shown on all screens
      ══════════════════════════════════════ */}
      <div className="fdl-header">
        <div className="fdl-header-inner">
          {/* Logo row */}
          <div className="fdl-logo-row">
            <div className="fdl-logo-badge">
              <span className="soccer-icon">⚽</span>
              <div>
                <div className="fdl-text">FDL</div>
                <div className="fdl-sub">Football Development League</div>
              </div>
            </div>
          </div>
